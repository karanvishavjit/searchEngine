...
public final class Sort
{
    ...
    public static String generateRandomString(int leng) {
    	...
    	for(int i=0;i<leng;i++) {
    		int index=(int) Math.floor(52*Math.random());
    		randomString+=alphabets.charAt(index);
    	}
...
//        String [] str= new String[NUM_ITEMS];
        ...
        for (int i=0;i<a.length;i++) {
            	a[i]= rand.nextInt(NUM_ITEMS*10);
            }
        start=System.nanoTime();    
            Sort.mergeSort(a);
        end= System.nanoTime();
        hm.put("Merge Sort", end-start);
        System.out.println("Time taken by merge sort is : "+ (end-start));
        checkSort(a);
        
//        for(int i=0;i<str.length;i++) {
//        	str[i]=generateRandomString(4);
//        }
//        Sort.mergeSort(str);
//        for(String s:str) {
//        	System.out.print(s+" ");
...
//        Sort.mergeSort(a);
//        end= System.nanoTime();
//        System.out.println("Average time taken by merge sort is : "+(end-start)/NUM_ITEMS*5);
//        checkSort(a);
        ...
        hm.put("quick Sort", end-start);
        System.out.println("Time taken by quick sort is sort is : "+ (end-start));
        checkSort( a );
        ...
        hm.put("Heap Sort", end-start);
        System.out.println("Time taken by heap sort is sort is : "+ (end-start));
        checkSort( a );
        ...
        hm.put("Dual Pivot Sort", end-start);
        System.out.println("Time taken by dual pivot sort is sort is : "+ (end-start));
        checkSort( a );
        ...
        System.out.println("10 smallest:");
        Sort.mergeSort(a);
        Sort.print(a);
        System.out.println(k+"th smallest = " + a[k-1]);
        
        for(Entry<String, Long> value:hm.entrySet()) {
